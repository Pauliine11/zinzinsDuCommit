...
<h1>Modifier le commentaire</h1>
 <form method="POST">
    <div class="container">
        <div class="form-group formularStyle">
            <label for="comment" class="form-label">Quelque chose à redire ?</label>
        ...
        <button type="submit" name="editComment" class="btn greyBtn mt-3">Modifier</button>
    </div>
</form>
<?php
